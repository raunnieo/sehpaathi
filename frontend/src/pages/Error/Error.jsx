...
const Error = () => {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden flex flex-col justify-center items-center text-center px-4 ${
      ...
      </div>      <div className="relative z-10 max-w-2xl mx-auto">
        <div className={`backdrop-blur-xl border p-12 rounded-3xl shadow-2xl flex flex-col items-center ${
          isDark 
